...
function ImageConverterOCR() {
  ...
  const [processing, setProcessing] = useState<ImageProcessingState>({
    image: null,fileName: "",text: "",isLoading: false,isUploading: false,progress: 0,});
  ...
  const saveToServer = async (
    ...
    try {
      ...
      // const jsonObject = JSON.parse(extractedText);

      console.log("extractedTextextractedText",extractedText);
